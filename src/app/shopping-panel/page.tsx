...
export default function PurchaseForm() {
  ...
  return (
    <div className="min-h-screen bg-[#e0ffff]">
      ...
      <main className="p-6 max-w-6xl mx-auto">
        ...
        <div className="grid md:grid-cols-[1fr_auto] gap-8">
          ...
          <div className="bg-white rounded-3xl p-8 shadow-lg">
            <h3 className="text-[#005452] text-3xl font-bold mb-8">ORDEN DE COMPRA</h3>

            <div className="space-y-6">
              <div className="grid gap-2">
                <label className="text-xl">Nombre</label>
                <Input placeholder="Nombre del medicamento" className="bg-[#e0ffff] border-none h-12" />
              </div>

              <div className="grid gap-2">
                <label className="text-xl">Forma de pago</label>
                <Input placeholder="Pago" className="bg-[#e0ffff] border-none h-12" />
              </div>

              <div className="grid gap-2">
                <label className="text-xl">Laboratorio que lo comercializa</label>
                <Select>
              ...
              <div className="grid gap-2">
                ...
                <Input placeholder="Nombre del analista" className="bg-[#e0ffff] border-none h-12" />
              </div>
            </div>
          </div>
      ...
      {/* Footer */}
      <footer className="bg-[#04232f] text-white p-4 text-center mt-12">2025 - FarmaToronto</footer>
    </div>
  )
}
